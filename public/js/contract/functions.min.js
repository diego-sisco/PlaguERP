    ...
    var html = `
            <tr>
                ...
                <td class="text-center">
                    <select id="exec${i}" class="form-select border-secondary border-opacity-25" onchange="setFrecuency(${i})">
                ...
                <td class="text-center">
                    <select class="form-select border-secondary border-opacity-25" id="interval${i}" onchange="setDays(${i})" ${
