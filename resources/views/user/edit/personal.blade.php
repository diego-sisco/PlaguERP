<form class="form" method="POST" action="{{ route('user.update', ['id' => $user->id]) }}" enctype="multipart/form-data"
    ...
    <div class="row mb-3">
        ...
        <div class="col-2">
            ...
            <input type="text" class="form-control border-secondary border-opacity-25" id="password" name="password"
    ...
    @if ($user->type_id == 1)
        <div class="row mb-3">
            <div class="col-2">
                ...
                <input type="date" class="form-control border-secondary border-opacity-25" id="birthdate"
            ...
            <div class="col-2">
                ...
                <input type="number" class="form-control border-secondary border-opacity-25" id="company_phone"
        ...
        <div class="row mb-3">
            ...
            <div class="col-2 mb-3">
                ...
                <input type="text" class="form-control border-secondary border-opacity-25 " value="México"
                    disabled>
        ...
        <div class="row">
            <div class="col-4 mb-3">
                ...
                <input type="text" class="form-control border-secondary border-opacity-25" id="curp"
            ...
            <div class="col-4 mb-3">
                ...
                <input type="number" class="form-control border-secondary border-opacity-25" id="nss"
            ...
            <div class="col-4 mb-3">
                ...
                <input type="text" class="form-control border-secondary border-opacity-25" id="rfc"
