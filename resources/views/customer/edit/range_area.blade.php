<div class="row">
    <div class="col-4 mb-3">
        ...
        <select class="form-select border-secondary border-opacity-50 " id="branch"
            name="branch_id">
    ...
    <div class="col-auto mb-3">
        ...
        <select class="form-select border-secondary border-opacity-50 " id="unit" name="unit">
    ...
    <div class="col-auto mb-3">
        ...
        <select class="form-select border-secondary border-opacity-50 " name="print_doc" id="print_doc">
    ...
    <div class="col-auto mb-3">
        ...
        <select class="form-select border-secondary border-opacity-50 " name="validate_certificate"
