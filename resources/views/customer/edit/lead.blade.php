<form method="POST" action="{{ route('customer.update', ['id' => $client->id, 'type' => 1]) }}"
    ...
    <div class="row mb-2">
        ...
        <div class="col-4">
            ...
            <input type="number" min=1000000000 max=9999999999 class="form-control border-secondary border-opacity-25" id="phone" name="phone"
    ...
    <div class="row mb-1">
        <div class="col-6">
            ...
            <input type="text" class="form-control border-secondary border-opacity-25" id="address" value="{{ $client->address }}"
        ...
        <div class="col-2">
            ...
            <input type="number" min=10000 max=99999 class="form-control border-secondary border-opacity-25" name="zip_code"
        ...
        <div class="col-2">
            ...
            <select type="text" class="form-select border-secondary border-opacity-25 " id="city" name="city" required>
                @foreach ($states as $state)
                    @if ($state['key'] == $client->state)
    ...
    <div class="row mb-3">
        <div class="col-3">
            ...
            <select type="text" class="form-select border-secondary border-opacity-25 " id="service-type" name="service_type"
        ...
        <div class="col-3" id="company-type">
            ...
            <select type="text" class="form-select border-secondary border-opacity-25 " id="category"
                name="category">
        ...
        <div class="col-12 mb-3">
            ...
            <input type="text" class="form-control border-secondary border-opacity-25" id="url" name="url"
