    ...
    <div class="row">
        ...
        <div class="col-3 mb-3">
            ...
            <select class="form-select border-secondary border-opacity-25 " id="business_line_id" name="business_line_id" required>
                @foreach ($business_lines as $business_line)
                    <option value="{{ $business_line->id }}">{{ $business_line->name }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="col-12 mb-3">
            ...
            <textarea type="text" class="form-control border-secondary border-opacity-25 p-3" id="description" name="description"
                rows="7" placeholder="{{ __('service.data.input.description') }}" style="text-align: justify;" required>S/D</textarea>
        </div>
...
<script>
    ...
    function set_instructions() {
        ...
        if (value == 2) {
            ...
            DESPUES DE LA APLICACIÓN QUÍMICA
