...
@section('content')
    ...
    <script>
        ...
        function createPoint(x, y, index, width, height) {
            ...
            pointElement.innerText = index.toString();
        ...
        function setDevices() {
            devices.forEach(function(device) {
                ...
                createPoint(device.map_x, device.map_y, device.itemnumber, device.img_tamx, device.img_tamy);
            });
        }
        ...
        document.getElementById('print-button').addEventListener('click', function() {
            ...
            devices.forEach(function(point) {
                ...
                doc.setFontSize(10);
                doc.text(point.itemnumber.toString(), 10 + adjustedX / 4 + 2, 10 + adjustedY / 4 + 2);
            });
