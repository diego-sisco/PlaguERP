<div class="row mb-4 justify-content-between">
    ...
    <div class="col-7">
        <input type="file" class="form-control border-secondary border-opacity-50 rounded" accept=".png, .jpg, .jpeg"
            name="file" id="file">
    </div>
</div>
<div class="row">
    <div class="col-4 mb-3">
        ...
        <input type="string" class="form-control border-secondary border-opacity-50" id="filename" name="filename"
...
<div class="row mb-3">
    <div class="col-6 mb-3">
        ...
        <select class="form-select border-secondary border-opacity-50 " id="service_id" name="service_id">
