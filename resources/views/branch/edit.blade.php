                ...
                @if ($section == 1)
                    <div class="row mb-3">
                        ...
                        <div class="col-2 mb-2">
                            ...
                            <select class="form-select border-secondary border-opacity-25 " id="status" name="status_id">
                                <option value="1"{{ $branch->status_id == 1 ? 'selected' : ''}}> Activo </option>
                                <option value="2"{{ $branch->status_id != 1 ? 'selected' : ''}}> Inactivo </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <div class="form-text" id="basic-addon4">Ingresa la colonia donde se encuentra la sucursal.
                            </div>
                        </div>
                        <div class="col-2 mb-2">
                        ...
                        <div class="col-3 mb-2">
                            ...
                            <div class="form-text" id="basic-addon4">Selecciona primero el <b>Estado</b> y después la
                                ciudad.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6 mb-2">
                            ...
                            <input type="text" class="form-control border-secondary border-opacity-25"
                                id="license_number" name="license_number" value="{{ $branch->license_number }}" required>
