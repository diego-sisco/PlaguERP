<div class="row">
    <div class="col-3 mb-3">
        ...
        <input type="number" class="form-control border-secondary border-opacity-25" name="econ_price"
    ...
    <div class="col-4 mb-3">
        <label for="supplier" class="form-label">{{ __('product.econom-data-product.supplier') }}
            :</label>
        <select class="form-control border-secondary border-opacity-25" name="supplier_id"
            id="supplier_id">
...
<div class="row">
    <div class="col-2 mb-3">
        ...
        <select class="form-select border-secondary border-opacity-25 " name="product_sale"
