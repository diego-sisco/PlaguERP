        ...
        <div class="col-11">
            <div class="row p-3 border-bottom">
                <a href="{{ route('point.index', ['page' => 1]) }}" class="col-auto btn-primary p-0 fs-3"><i
                        ...
                        <h1 class="col-auto fs-2 fw-bold m-0">{{ __('product.point.show') }} {{ $point->id }} [{{ $point->name }}]:
                        @if ($section == 1)
                        Datos generales
                    @elseif($section == 2)
                        Preguntas
            ...
            <div class="row p-5 pt-3">
                @switch($section)
                    @case(1)
                        @include('product.control_point.form-edit-point')
                    @break

                    @case(2)
                        <div class="col-12 mb-3">
                            <a href="{{ route('question.create', ['pointID' => $point->id, 'section' => $section]) }}"
