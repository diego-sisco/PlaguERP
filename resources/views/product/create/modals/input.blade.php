    ...
    <div class="modal-dialog">
        <form class="modal-content" class="form" method="POST" action="{{ route('product.input', [ 'id' => $product->id]) }}">
            ...
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="inputModalLabel">Crear insumo</h1>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="appMethod" name="application_method_id" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="zone-m2" name="zone_m2" value="0"
